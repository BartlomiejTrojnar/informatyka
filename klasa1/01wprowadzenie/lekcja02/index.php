...
<head>
  ...
  <title>Lekcja 2<br />Nazywanie i zapisywanie plików, korzystanie z poczty e-mail</title>
</head>

<body>
  <header>Lekcja 2<br />Nazywanie i zapisywanie plików, korzystanie z poczty e-mail</header>

  <article>
    <p style="font-size: 1.5em; color: red; background: yellow; text-align: center;">Treść lekcji nieaktualna (w przygotowaniu)</p>

    <p>Czym jest rozszerzenie nazwy pliku? Po co jest rozszerzenie nazwy? Pokazywanie pełnych nazw plików (z rozszerzeniami). Nazywanie plików - ćwiczenia.</p>
    <p>Konfiguracja poczty e-mail</p>
  </article>
