...
<head>
  ...
  <title>Lekcja 5<br />Uczestnictwo w kursie e‑learningowym</title>
</head>

<body>
  <header>Lekcja 5<br />Uczestnictwo w kursie e‑learningowym</header>

  <article>
    <p style="font-size: 1.5em; color: red; background: yellow; text-align: center;">Treść lekcji w przygotowaniu</p>
  </article>
